...
//  SoccerApp
//
//  Created by Leo Chernyak on 8/22/20.
//  Copyright © 2020 Leo Chernyak. All rights reserved.
//
...
class BallDetectionController: MainViewController {
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "Model", withExtension: "mlmodelc") else {
            return NSError(domain: "VisionObjectRecognitionViewController", code: -1, userInfo: [NSLocalizedDescriptionKey: "Model missed"])
        }
        do {
